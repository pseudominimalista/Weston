...
execute_process(
  COMMAND "/bin/git" --git-dir=.git show-ref "64f1775952dbe001e989f2ab679563b54f2fca55"
  WORKING_DIRECTORY "/home/john/.emacs.d/elpa/vterm-20230130.745/build/libvterm-prefix/src/libvterm"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/john/.emacs.d/elpa/vterm-20230130.745/build/libvterm-prefix/src/libvterm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/john/.emacs.d/elpa/vterm-20230130.745/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
